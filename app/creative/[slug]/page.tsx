...
const CRITIQUES = [
  ...
  },
  {
    ...
    rating: 5,
    text: "Beautifully written. The Mumbai setting feels lived-in and real, and the ethical questions the story raises don't have easy answers. This is science fiction doing what it does best — making you think.",
  },
  {
    id: 4,
    user: "Aditya M.",
    ...
    rating: 4,
    text: "Solid debut novel. A few subplots feel undercooked but the central narrative is gripping. The dialogue between Aryan and his professor in Chapter 3 is exceptional — felt like reading a real philosophical debate.",
  },
];
